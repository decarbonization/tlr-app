...
extension UTType {
    static let library = UTType(exportedAs: "io.github.decarbonization.TheListeningRoom.library",
                                conformingTo: .database)
    
    static let libraryItem = UTType(exportedAs: "io.github.decarbonization.TheListeningRoom.item",
                                    conformingTo: .data)
}
...
func makeAppModelContainer() -> ModelContainer {
    ...
    let appModelConfiguration = ModelConfiguration("The Listening Room Music Library",
                                                   schema: appSchema,
                                                   url: appLibraryURL,
                                                   allowsSave: true,
