...
@Observable final class PlayQueue: @unchecked Sendable {
    static let playbackStateDidChange = Notification.Name("TheListeningRoom.PlayQueue.playbackStateDidChange")
    static let nowPlayingDidChange = Notification.Name("TheListeningRoom.PlayQueue.nowPlayingDidChange")
    ...
    static let log = Logger(subsystem: "io.github.decarbonization.TheListeningRoom", category: "PlayQueue")
    ...
    private func consumeDelegateEvent(_ event: DelegateEvent) {
        ...
        case .playbackStateChanged(let newPlaybackState):
            withMutation(keyPath: \.playbackState) {
                ...
                NotificationCenter.default.post(name: PlayQueue.playbackStateDidChange, object: self)
        ...
        case .nowPlayingChanged(_):
            NotificationCenter.default.post(name: PlayQueue.nowPlayingDidChange, object: self)
